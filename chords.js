window.LAGREY_CHORDS = (() => {
  ...
  function movableShapes(symbol){ const p=parseChord(symbol); if(!p||p.bass) return []; const q=p.quality,out=[],fE=fretFrom(p.root,"E"),fA=fretFrom(p.root,"A"),e=fE===0?12:fE,a=fA===0?12:fA,add=(label,frets,fingers)=>out.push({label,frets,fingers}); if(q===""){add("Forma E",[e,e+2,e+2,e+1,e,e],[1,3,4,2,1,1]);add("Forma A",["x",a,a+2,a+2,a+2,a],["",1,3,3,3,1]);}else if(q==="m"){add("Forma Em",[e,e+2,e+2,e,e,e],[1,3,4,1,1,1]);add("Forma Am",["x",a,a+2,a+2,a+1,a],["",1,3,4,2,1]);}else if(q==="7"){add("Forma E7",[e,e+2,e,e+1,e,e],[1,3,1,2,1,1]);add("Forma A7",["x",a,a+2,a,a+2,a],["",1,3,1,4,1]);}else if(q==="maj7"){add("Forma Amaj7",["x",a,a+2,a+1,a+2,a],["",1,3,2,4,1]);}else if(q==="m7"){add("Forma Em7",[e,e+2,e,e,e,e],[1,3,1,1,1,1]);add("Forma Am7",["x",a,a+2,a,a+1,a],["",1,3,1,2,1]);}else if(q==="sus4"){add("Forma Esus4",[e,e+2,e+2,e+2,e,e],[1,2,3,4,1,1]);add("Forma Asus4",["x",a,a+2,a+2,a+3,a],["",1,2,3,4,1]);}else if(q==="sus2"){add("Forma Asus2",["x",a,a+2,a+2,a,a],["",1,3,4,1,1]);} return out.filter(v=>{const nums=v.frets.filter(x=>typeof x==="number");return nums.length&&Math.max(...nums)<=16;}); }
