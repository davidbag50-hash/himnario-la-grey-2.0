...
const BASE='./cloud/';
const FILES=['config.js','data-service.js','supabase-client.js','auth-service.js','ministry-service.js','bootstrap.js','diagnostics.js','favorites-sync.js'];
...
(async()=>{
  try{
    ...
    await loadRoot('account-onboarding-v1.js');
