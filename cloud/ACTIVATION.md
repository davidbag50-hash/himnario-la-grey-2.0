...
15. `20260924_000015_user_practice_sessions.sql`
    - historial privado de práctica por usuario
...
16. `20260924_000016_user_learning_goals.sql`
    - objetivos personales privados
    - contexto opcional de ruta/canción/evento
    - estado activo/completado/archivado con RLS por usuario
