(()=>{
 ...
 const consolidated=document.createElement('script');consolidated.src='la-grey-consolidation-v1.js?v=94';consolidated.async=false;document.head.appendChild(consolidated);
})();