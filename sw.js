const CACHE='la-grey-v2-6-performance';
const ASSETS=['./','./index.html','./styles.css','./profiles.css','./performance.css','./songs.js','./chords.js','./members.js','./app.js','./profiles.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
