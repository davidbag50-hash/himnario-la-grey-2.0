const CACHE='la-grey-v3-203-offline-shell-guard';
...
const OPTIONAL_ASSETS=['./robots.txt','./sitemap.xml','./sitemap.txt','./voice-foldables-v1.css','./voice-foldables-v1.js','./credential-isolation-v1.js','./account-onboarding-v2.js','./members-roster-v1.js','./members-roster-state-fix-v1.js','./members-management-v1.js','./song-seo-v1.js','./cloud/config.js','./cloud/data-service.js','./cloud/supabase-client.js','./cloud/auth-service.js','./cloud/ministry-service.js','./cloud/bootstrap.js','./cloud/diagnostics.js','./cloud/favorites-sync.js','./cloud/loader.js','./academy-videos/passaggio/scene-01.svg'];
