const CACHE='la-grey-v2-7-stage-ui';
const ASSETS=['./','./index.html','./styles.css','./profiles.css','./performance.css','./stage-ui.css','./songs.js','./chords.js','./members.js','./app.js','./profiles.js','./stage-ui.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
