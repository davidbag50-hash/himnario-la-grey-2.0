...
for(const token of ['getLearningProgress','setLearningItemCompleted','getPersonalSongNote','savePersonalSongNote','saveEventAssignments','respondToEvent','getEventTemplates','saveEventTemplate','deleteEventTemplate']){
...
const templates=read(path.join(migrationDir,'20260924_000015_event_templates.sql'));
