...
function siteStructured(){const meta=HOME_SEO[lang()],el=document.getElementById('siteSeoJsonLd');if(el)el.textContent=JSON.stringify({'@context':'https://schema.org','@type':'WebSite',name:'La Grey',alternateName:tx('Himnario-Cancionero La Grey','La Grey Hymns and Songs'),url:BASE,description:meta.desc,inLanguage:lang()})}
